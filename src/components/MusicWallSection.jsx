...
const songs = [
  ...
  { id: 3, title: 'تخيل', artist: 'عمرو دياب', color: '#f472b6',
    memory: 'بنرقص عليها كل ما نسمعها',
    lyric: '" تخيل لما بشوفك بعمل إيه "' },
  { id: 4, title: 'كان نفسي', artist: 'تامر حسني', color: '#fbbf24',
    memory: 'بتحببنا لبعض أكتر وأكتر',
    lyric: '" كان نفسي تكون معايا "' },
